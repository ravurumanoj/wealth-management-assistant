...
def get_customer_overview(state: CRMAgentState):
    ...
    try:
        result = call_mcp_tool("customer_overview", {"customer_id": customer_id})
...
def get_customer_interactions(state: CRMAgentState):
    ...
    customer_id = state["customer_id"]
    try:
        result = call_mcp_tool("customer_interactions", {"customer_id": customer_id})
        return {"response": [result]}
    except Exception:
...
def get_customer_portfolio(state: CRMAgentState):
    ...
    customer_id = state["customer_id"]
    try:
        result = call_mcp_tool("customer_portfolio", {"customer_id": customer_id})
        return {"response": [result]}
    except Exception:
...
def get_customer_risk_profile(state: CRMAgentState):
    ...
    customer_id = state["customer_id"]
    try:
        result = call_mcp_tool("customer_risk", {"customer_id": customer_id})
        return {"response": [result]}
    except Exception:
...
def get_customer_brief(state: CRMAgentState):
    ...
    customer_id = state["customer_id"]
    try:
        result = call_mcp_tool("customer_brief", {"customer_id": customer_id})
        return {"response": [result]}
    except Exception:
...
def get_customer_transactions(state: CRMAgentState):
    ...
    customer_id = state["customer_id"]
    try:
        result = call_mcp_tool("customer_transactions", {"customer_id": customer_id})
        return {"response": [result]}
    except Exception:
...
def customer_insights(state: CRMAgentState):
    ...
    prompt = f"""You are a CRM assistant for a Wealth Management firm. Your task is to assist relationship managers in providing 
    useful insights about their customers based on their queries.
    ...
    Always provide the insights by greeting the user.
    """
...
# pprint.pprint(result["user_insights"])
