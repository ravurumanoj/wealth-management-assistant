...
All functions are self-contained: they open a :func:`session_scope`, perform
the work, and return plain Python data structures (dicts / primitives) so the
service layer never deals with detached ORM instances.
"""
